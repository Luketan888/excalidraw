  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Drawthing by BraisedEgg",
          name: "Drawthing by BraisedEgg",
          description:
            "Drawthing by BraisedEgg is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
